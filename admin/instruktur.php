...
session_start();
include 'koneksi.php';
$queryInstruktur = mysqli_query($koneksi, "SELECT * FROM instruktur");
...
$rowInstruktur = mysqli_fetch_assoc($queryInstruktur)
?>
<!DOCTYPE html>
                                            ...
                                            <tbody>
                                                ...
                                                <?php while ($rowInstruktur = mysqli_fetch_assoc($queryInstruktur)) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td>
                                                            <img src="upload/<?php echo $rowInstruktur['foto'] ?>" alt="">
                                                        </td>
                                                        <td><?php echo $rowInstruktur['nama_instruktur'] ?></td>
                                                        <td><?php echo $rowInstruktur['bidang'] ?></td>
                                                        <td>
                                                            <a href="tambah-instruktur.php?edit=<?php echo $rowInstruktur['id'] ?>" class="btn btn-success btn-sm">Edit</a>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"
                                                                href="instruktur.php?delete=<?php echo $rowInstruktur['id'] ?>" class="btn btn-danger btn-sm">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
