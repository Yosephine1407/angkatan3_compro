                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="contact-admin.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="kirim-pesan.php?pesanId=<?php echo $rowContact['id'] ?>" class="btn btn-success btn-sm">Balas Pesan</a>
                                                            <span class="tf-icon bx bx-pencil bx-18px"></span>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"
                                                                href="contact.php?delete=<?php echo $rowContact['id'] ?>" class="btn btn-danger btn-sm">Delete</a>
